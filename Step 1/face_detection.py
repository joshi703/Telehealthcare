...
# img declaration
joshik = face_rec.load_image_file(r'C:\Users\DELL\Desktop\face_recogniton-learnFromBasics-main\sample_images\joshik.jpg' )
joshik = cv2.cvtColor(joshik, cv2.COLOR_BGR2RGB)
joshik = resize(joshik, 0.50)
joshik_test = face_rec.load_image_file(r'C:\Users\DELL\Desktop\face_recogniton-learnFromBasics-main\elon musk.jpg')
